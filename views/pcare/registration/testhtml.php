...
//        $this->writeHTMLCell(100, 100, '', '', $html, 1, 1, 0, true, '', true);
...
$subtable = '<table border="0" cellspacing="0" cellpadding="4"><tr><td colspan="1">No Rujukan</td><td colspan="2">: '.$visitModel->noKunjungan.'</td></tr>
<tr><td colspan="1">FKTP</td><td colspan="2">: '.json_decode($visitModel->meta_rujukan)->name.'</td></tr>
<tr><td colspan="1">Kabupaten/Kota</td><td colspan="2">: '.json_decode($visitModel->meta_rujukan)->nmkc.'</td></tr></table>';
...
$subtable3 = '<table border="0" cellspacing="2" cellpadding="4">
...
<tr><td colspan="1">Diagnosa</td><td colspan="2">: '.$visitModel->nmDiag1 . '(' . $visitModel->kdDiag1.')</td></tr>
<tr><td colspan="1">Telah diberikan</td><td colspan="2">: </td></tr>
</table>';

$subtable4 = '<table border="0" cellspacing="2" cellpadding="4">
...
$subtable5 = '<table border="0" cellspacing="2" cellpadding="4">
